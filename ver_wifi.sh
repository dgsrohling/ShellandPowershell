...
# COM ESSE SCRIPT SIMPLES EH POSSIVEL SABER QUAIS SAO AS REDES WIFI QUE EXISTEM PROXIMAS AO HOST REMOTO
# CASO ESSE POSSUA UMA PLACA DE REDE ATIVA, É POSSIVEL SABER OS PERFILS SALVOS E SUAS COFIGURACOES.
